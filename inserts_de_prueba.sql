INSERT INTO usuario (telefono, num, direccion) VALUES
('+5491123456789', 1, 'Av. Siempre Viva 123'),
('+5492234567890', 2, 'Calle Ficticia 456');
...
('2025-01-13 15:45:00', 600, '+5491123456789', '+5492234567890', 1, 'Internacional');
-- Insertar una boleta para un usuario
INSERT INTO boleta (usuario_id, costo_total) VALUES
(1, 150.00),  -- Boleta para el usuario con id 1
(2, 80.00);   -- Boleta para el usuario con id 2
-- Relacionar las llamadas con una boleta
UPDATE llamadas
SET boleta_id = 1
WHERE numDeSalida = '+5491123456789' AND usuario_id = 1;

UPDATE llamadas
SET boleta_id = 2
WHERE numDeSalida = '+5492234567890' AND usuario_id = 2;